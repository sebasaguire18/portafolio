	...
	<div class="navbar navbar-default bs-dos-nav navbar-fixed-top sticky-navigation" role="navigation">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a href="#home" class="navbar-brand smoothScroll">SEBASTIÁN AGUIRRE V.</a>
			</div>
			<nav class="collapse navbar-collapse" id="rock-navigation">
				<ul class="nav navbar-nav navbar-right main-navigation text-uppercase">
					<li><a href="#home" class="smoothScroll">Inicio</a></li>
					<li><a href="#work" class="smoothScroll">Mi Trabajo</a></li>
					<li><a href="#portfolio" class="smoothScroll">Portafolio</a></li>
					<li><a href="#resume" class="smoothScroll">Resumen</a></li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8 col-sm-10">
					<h1 class="tm-home-title"><strong>Sebastián Aguirre V.</strong></h1>
					<h2 class="tm-home-subtitle">Desarrollador de Software</h2>
					<p>Soy un <strong>desarrollador de Software Full Stack</strong> graduado del SENA. <br> Desarrollo aplicaciones <strong>Web</strong> y <strong>Software Web Empresarial</strong>. Listo para servir. Gracias.</p>
					<a href="#work" class="btn btn-default smoothScroll tm-view-more-btn">Seguir leyendo</a>
				</div>
				<div class="col-md-2 col-sm-1"></div>
			</div>
		</div>
	...
	<section id="work" class="tm-padding-top-bottom-100">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-4">
					<h2 class="title">Mi <strong>Trabajo</strong></h2>						
				</div>
			</div>
			<div class="row justify-content-between">
				<div class="col-md-4 col-sm-4">
					<div class="work-wrapper">
						...
						<hr>
						<p>Desarrollo aplicaciones web a la medida, con tecnologías que me ayudan a ahorrar tiempo y que me aportan calidad a la web en general.</p>
					</div>
				</div>
				<div class="col-md-4 col-sm-4">
					<div class="work-wrapper">
						<i class="fa fa-dashboard"></i>
						<h3 class="text-uppercase tm-work-h3">HTML Plantillas</h3>
						<hr>
						<p>Rediseño, organizo y modifico plantillas de plataformas web ya realizadas, páginas de muestra o plantillas web gratis. Este tipo de desarrollos es más económico.</p>
					</div>
				</div>
			</div>
		</div>
